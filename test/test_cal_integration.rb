...
#also if year is between 1800 and 3000
  ...
  def test_01_ARGV_inputs
    shell_output = `ruby cal.rb 2 2012`
    assert_equal(["2", "2012"], ARGV)
  end

  def test_02_month_output_1_2012
...
EOS
  ...
  def test_03_month_output_2_2012
...
EOS
  ...
  def test_04_month_output_9_2012
...
EOS
  ...
  def test_05_month_output_2_2015
...
EOS
  ...
  def test_06_month_output_2_1900
...
EOS
  ...
  def test_07_month_output_2_2000
